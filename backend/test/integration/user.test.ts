...
describe('Auth routes', () => {
	describe('POST /v1/auth/register', () => {
		let newUser: { email: string; password: string; name: string; role: Role };
		beforeEach(() => {
			newUser = {
	...
	describe('GET /v1/users/:userId', () => {
		...
		test('should return 400 error if userId is not valid', async () => {
			await insertUsers([admin]);
